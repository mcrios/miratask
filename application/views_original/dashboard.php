   ...
   <div id="content-you-billed" class="x_content">
    <article class="media event">
      <div class="media-body">
        <p><?=number_format($youBilled->Total,0)?> <small>Billables Fies</small></p>
        <hr>
        <p>$ <?=number_format($youBilled->total_ingreso,2)?> <small>Total Billed</small></p>
      </div>
    </article>
  </div>
...
<div class="col-xs-6 dashBox dashBoxLarge">
  ...
  <div id="meetings_appointments" class="dashMeet">
    ...
    <h2> &nbsp; <img src="<?=base_url()?>img/contact_group.png"> &nbsp; Meetings and Appointments</h2>
    ...
    <div role="tabpanel" class="cero" data-example-id="togglable-tabs">
      ...
      <ul id="dashOpc" class="nav nav-tabs bar_tabs" role="tablist">
       ...
       <li  class="<?=$actives[1]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Today"  >Today</a></li>
       <li  class="<?=$actives[2]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Tomorrow"  >Tomorrow</a></li>
       <li  class="<?=$actives[3]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Week" >Week</a></li>
  ...
  <div id="meetings_appointments"  class="dashMeet">
    ...
    <div class="mytaskscroll" role="tabpanel" data-example-id="togglable-tabs">
      ...
      <ul id="dashOpc" class="nav nav-tabs bar_tabs  "  >
       <li class="<?=$actives[1]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Today">Today</a></li>
       <li class="<?=$actives[2]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Tomorrow">Tomorrow</a></li>
       <li class="<?=$actives[3]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Priority">Priority</a></li>
       <li class="<?=$actives[4]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Overdue">Overdue</a></li>
     </ul>
   </div>
...
<div class="col-md-12  dashBoxLarge">
  <div class="x_panel">
    ...
    <div id="recent-activity" class="x_title">
      <h2> &nbsp; <img src="<?=base_url()?>img/contact_group.png"> &nbsp; Recent Activity</h2>
      <div class="clearfix"></div>
    </div>
  ...
  <div class="row">
   ...
   <div class="center" style="width:800px; margin-left:250px;">
    <div   class="mbr-cards-col col-xs-12 col-lg-4">
      ...
      <a href="mailto:soporte@web-informatica.com"><img src="<?=base_url()?>img/Email.png"></a>
    ...
    <div   class="mbr-cards-col col-xs-12 col-lg-4">
      ...
      <a href="mailto:soporte@web-informatica.com"><img src="<?=base_url()?>img/TecnicalSuport.png"></a>
