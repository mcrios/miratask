				...
				<div class="col-xs-12" >
					...
					<div class="addUserInputWrap">
						...
						<div class="addUser">
							...
							<br>	 
							Select the information you want to appear in the header of invoice
						...
						<table class="addUser " style="margin-top: 5px;">
							...
							<tr>
					 			...
					 			<td style="width: 120px;">Firm Name*</td>
					 			<td>
					 		...
					 		<tr>
					 			...
					 			<td style="width: 120px;">Display Name*</td>
					 		...
					 		<tr>
					 			...
					 			<td style="width: 120px;">Contact Name*</td>
					 			<td>
					 		...
					 		<tr>
					 			...
					 			<td style="width: 120px;">Upload Logo</td>
					 		...
					 		<tr>
							 	...
							 	<td>
									...
									<div class="col-md-3" style="float:right;">
										<a id="cancel"   class="btn btn-primary btn-lg btn-block" href="<?=base_url()?>inv_setting"   >Cancel </a>
									</div>
