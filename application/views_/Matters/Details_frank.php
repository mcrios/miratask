				...
				<div id="content_meetings_appointments" class="tab-content">
					...
					<!-- events *************** Events  -->
								...
								<div class="panelaccc">
									...
									foreach($events as $i => $event): ?>
										...
										<tr>
											...
											<td> <?=decodedate($event->start_fulldate)?></td>
						...
						<!-- TASK -->		
								...
								<span class="plusRelCl"   onclick="createTask('<?=$Matter->Id?>','Matters/Details/<?=$Matter->Id?>?tab=records')"><img src="<?=base_app()?>/img/add_adress.jpg" ></span>
					...
					<div role="tabpanel" class="tab-pane fade" id="tcontenido6" aria-labelledby="profile-tab">
						<div id="task1" class="col-md-12">
							 <?php $this->load->view('Matters/billing-matter'); ?>
						</div>
					</div> <!-- /contenido6 -->
