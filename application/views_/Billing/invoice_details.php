...
<div class="col-md-3 pl0">
	<a id="add_matters" class="btn btn-primary btn-lg btn-block" href="<?=base_app()?>Billing/deleteDraft/<?=$Invoice->Id?>">
	...
	<div class="">
		...
		<div class="col-md-5">
			 	<?php 
			 		...
			 		$BillTo     = isset($Cliente->Id) ? $Cliente->Id : "" ;
	...
	<div class="col-md-12">
		...
		<div id="resultTable">
			...
			<tr >
				<td colspan="4">
					...
					<textarea name="comments" style="border:1px solid #f3f3f3; width:390px;"><?=$Invoice->Comments?></textarea>	
		...
		<div class="row">
			...
			<div  class="col-sm-8">
					...
					<input id="saveAsInvoice" value="Save AS invoice" class="btn-lg invb fr" style="background:#07bdbf; border-color:#05a894;" type="button"> 
