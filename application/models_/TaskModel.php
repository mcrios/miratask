...
class TaskModel extends CI_Model {
	...
	function getTotal($ActualLetter){
		...
		$query = "SELECT COUNT(Id) AS total FROM ml_ta_task WHERE Status!='' ".$ActualLetter." ";
	...
	function ListAll($limit1,$limit2,$where){
		...
		$query = "SELECT  *   FROM ml_ta_task ta WHERE Status!='' ".$where."  ORDER BY Date DESC LIMIT ".$limit1.",".$limit2."  ";
