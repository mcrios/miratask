					...
					<div class="addUserInputWrap">
						...
						<table class="addUser">
					 		...
					 		<tr>
					 			...
					 			<td>
					 				<div class="role"><input type="radio" value="1" name="Role" id="Role" <?php echo (set_value('Role')=="1")?" checked=' checked'":""?>> Admin   </div>
					 				<div class="role"><input type="radio" value="2" name="Role" id="Role" <?php echo (set_value('Role')=="2")?" checked=' checked'":""?>> Atorney </div>
					 				<div class="role"><input type="radio" value="3" name="Role" id="Role" <?php echo (set_value('Role')=="3")?" checked=' checked'":""?>> Staff   </div>
					 			</td>
					 		</tr>
					 		<tr>
					 			<td> 
