  				...
  				<div class="TaskallInputWrap">
					...
					<div class="form-group row">
						<div class="shortSelectWrap1 btn-group ml-2">
							...
							<button style="z-index: 10000" id="PriorityButt" type="button" class="shortSelect" ><?=$PriorityName->Name?></button>
					...
					<div class="form-group row">
						<div class="shortSelectWrap1 btn-group ml-2">
							...
							<input type="text" name="StartTime" id="StartTime" value="<?=decodedate($task->StartDate)?>" class="shortSelect"  />
						...
						<div class="shortSelectWrap2 btn-group ml-2">
							...
							<input  id="EndTime"    type="text"   name="EndTime" value="<?=decodedate($task->DueDate)?>" class="shortSelect"  />
								...
								foreach ($relations as $key  ) { 
									...
									<span id="ContMAtterButt<?=$key->IdObject?>" class="staffItem  btn btn-default btn-xs"> 
										...
										<div class="form-group row fitButtons ">
											...
											<div class="col-md-3">
												<a id="cancel"  href="<?=base_app()?>Task" class="btn btn-primary btn-lg btn-block"  >Cancel </button>
												</div>
