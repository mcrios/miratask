 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3 class="lang"><?php echo $this->lang->line('mensaje_inicio'); ?></h3><hr>
 </div>
 	...
 	<div   class="dashboardWrap matterContent" >
 		...
 		<div class="col-md-4 dashBox">
 			...
 			<div id="matters" class="x_title">
 				<h2><img src="<?=base_url()?>img/matters_blue.png"> &ensp;<?php echo $this->lang->line('dashboard_1'); ?></h2>
 			...
 			<div class="matCat">
 				...
 				{
 					$active = $ci->MatterModel->get_billing_status($row->Id);
 					$dateValidate =  strtotime($active->DueDate);
 					$today = strtotime(date('Y-m-d'));
 					if (!empty($active)) {
 						if (($active[0]->Status!= 'Draft' && $active[0]->Status!= 'Paid') && $today>$dateValidate) {
 							$alert = "vencido";
 						}
 						else{
 							$alert="";
 					...
 					<a class="<?=$alert?>" href="<?=base_app()."Matters/Details/".$row->Id?>">
 		...
 		<div class="col-md-4 dashBox">
 			...
 			<div id="task" class="x_title">
 				<h2><img src="<?=base_url()?>img/task.png"> &ensp;<?php echo $this->lang->line('dashboard_2'); ?></h2>
 				<!-- buscador -->
 				...
 				<div class="col-md-5">
 					...
 					<ul class="dropdown-menu btn-block" role="menu">
 						<li><a href="<?=base_app()?>/Dashboard/setFiltroTask/Today"><?php echo $this->lang->line('days_1'); ?></a></li>
 						<li><a href="<?=base_app()?>/Dashboard/setFiltroTask/Tomorrow"><?php echo $this->lang->line('days_2'); ?></a></li>
 						<li><a href="<?=base_app()?>/Dashboard/setFiltroTask/Week"><?php echo $this->lang->line('days_3'); ?></a></li>
 						<li><a href="<?=base_app()?>/Dashboard/setFiltroTask/Overdue"><?php echo $this->lang->line('days_5'); ?></a></li>
 						<li><a href="<?=base_app()?>/Dashboard/setFiltroTask/All"><?php echo $this->lang->line('none_1'); ?></a></li>
 					</ul>
 				</div>
 		...
 		<div class="col-md-4 dashBox">
 			<div class="x_panel">
 				...
 				<div id="you_billed" class="x_title">
 					...
 					<h2><img src="<?=base_url()?>img/Billing_blue.png"> &ensp; <?php echo $this->lang->line('dashboard_3'); ?></h2>
 					...
 					<div class="col-md-5">
 						...
 						<ul class="dropdown-menu btn-block" role="menu">
 							<li><a href="<?=base_app()?>/Dashboard/setYouBilled/Today"><?php echo $this->lang->line('days_1'); ?></a></li>
 							<li><a href="<?=base_app()?>/Dashboard/setYouBilled/Week"><?php echo $this->lang->line('days_3'); ?></a></li>
 							<li><a href="<?=base_app()?>/Dashboard/setYouBilled/Month"><?php echo $this->lang->line('days_6'); ?></a></li>
 							<li><a href="<?=base_app()?>/Dashboard/setYouBilled/Year"><?php echo $this->lang->line('days_7'); ?></a></li>
 						</ul>
 					</div>
 				...
 				<div id="content-you-billed" class="x_content">
 					<article class="media event">
 						<div class="media-body">
 							<p><?=number_format($youBilled->Total,0)?> <small><?=$this->lang->line('dashboard_6'); ?></small></p>
 							<hr>
 							<p>$ <?=number_format($youBilled->total_ingreso,2)?> <small><?=$this->lang->line('dashboard_7'); ?></small></p>
 						</div>
 					</article>
 				</div>
 		...
 		<div class="col-xs-6 dashBox dashBoxLarge">
 			...
 			<div id="meetings_appointments" class="dashMeet">
 				...
 				<h2> &nbsp; <img src="<?=base_url()?>img/contact_group.png"> &nbsp; <?php echo $this->lang->line('dashboard_4'); ?></h2>
 				...
 				<div role="tabpanel" class="cero" data-example-id="togglable-tabs">
 					...
 					if($lbXAct=="Today"){    $actives=""; $actives[1]="active"; }
 					if($lbXAct=="Tomorrow"){ $actives=""; $actives[2]="active"; }
 					if($lbXAct=="Week"){     $actives=""; $actives[3]="active"; }
 					...
 					<ul id="dashOpc" class="nav nav-tabs bar_tabs" role="tablist">
 						...
 						<li  class="<?=$actives[1]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Today"  ><?php echo $this->lang->line('days_1'); ?></a></li>
 						<li  class="<?=$actives[2]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Tomorrow"  ><?php echo $this->lang->line('days_2'); ?></a></li>
 						<li  class="<?=$actives[3]?>" ><a href="<?=base_app()?>Dashboard/setLastMetting/Week" ><?php echo $this->lang->line('days_3'); ?></a></li>
 		...
 		<div class="col-xs-6 dashBox dashBoxLarge">
 			...
 			<div id="meetings_appointments"  class="dashMeet">
 				...
 				<div class="mytaskscroll" role="tabpanel" data-example-id="togglable-tabs">
                    ...
                    //echo "lavel actual ".$lbAct;
 					if($lbAct=="Today"){    $actives=""; $actives[1]="active"; }
 					if($lbAct=="Tomorrow"){ $actives=""; $actives[2]="active"; }
 					if($lbAct=="Priority"){ $actives=""; $actives[3]="active"; }
 					if($lbAct=="Overdue"){  $actives=""; $actives[4]="active"; }
 					?>


 					<ul id="dashOpc" class="nav nav-tabs bar_tabs  "  >
 						<li class="<?=$actives[1]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Today"><?php echo $this->lang->line('days_1'); ?></a></li>
 						<li class="<?=$actives[2]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Tomorrow"><?php echo $this->lang->line('days_2'); ?></a></li>
 						<li class="<?=$actives[3]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Priority"><?php echo $this->lang->line('days_4'); ?></a></li>
 						<li class="<?=$actives[4]?>" ><a href="<?=base_app()?>Dashboard/setMYLastTask/Overdue"><?php echo $this->lang->line('days_5'); ?></a></li>
 					</ul>
 				</div>
 					...
 					{    
 						...
 						<div class="addMasWrap">        
 							<span class="" onclick="createTask()" for="">
 								<img src="<?=base_url()?>img/otrotask.png"> &nbsp; <?=$this->lang->line('task_2')?>
 							</span>
 						</div>    
 			...
 			<div class="col-md-12  dashBoxLarge">
 				<div class="x_panel">
 					...
 					<div id="recent-activity" class="x_title">
 						<h2> &nbsp; <img src="<?=base_url()?>img/contact_group.png"> &nbsp; <?php echo $this->lang->line('dashboard_5'); ?></h2>
 						<div class="clearfix"></div>
 					</div>
 	...
 	<div class="col-md-12" id="resources">
 		...
 		<div class="row">
 			...
 			<div class="center" style="width:800px; margin-left:250px;">
 				<div class="mbr-cards-col col-xs-12 col-lg-3 text-center">
 					<img src="<?=base_url()?>img/email_support.png">
 					<p class=""><?=$this->lang->line('dashboard_8')?></p>
 				</div>


 				<!-- segundo icono -->
 				<div class="mbr-cards-col col-xs-12 col-lg-3 text-center">
 					<a href="<?=base_url('docsxup/Manual_Usuario_Miratask.pdf')?>" target="_blank"><img src="<?=base_url()?>img/manual.png">
 						<p class=""><?=$this->lang->line('dashboard_9')?></p></a>
 					</div>

 					<div class="mbr-cards-col col-xs-12 col-lg-3 text-center">
 						<img src="<?=base_url('img/email_support.png')?>" alt="">
 						<p class=""><?=$this->lang->line('dashboard_10')?></p>
 					</div>
 				</div>
