 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo">
 	<h3 style="font-family: 'Arvo', sans-serif;"><?php echo $this->lang->line('adjust_1'); ?></h3><hr>
 </div>
 <div class="container">
 	<ul class="topMbar" id="topMbarWrap">
 		...
 		<div class="pull-right" style="margin-bottom: 20px;padding-right: 10px;">
 			<form class="form-inline" action="<?=base_url('Admin/Adjust_time')?>">
 				<div class="form-group">
 					<label for="date1"><?php echo $this->lang->line('adjust_2'); ?></label>
 					<script>
 						$(function(){
 		...
 		<a href="#" onclick="exportarXLS();" id="activador_xls" class="pull-left"><i class="fa fa-arrow-circle-down fa-2x" style="padding-right: 166px;padding-left:166px;padding-bottom:20px;margin-top: 20px;font-size: 18px;"> <?=$this->lang->line('adjust_28')?></i></a>
 	</ul>
 		...
 		<table class="table table-responsive table-striped" style="margin-top: 120px;" id="tabla">
 			<thead class="header-table-sessions">
 				<tr>
 					...
 					<th><?php echo $this->lang->line('adjust_5'); ?></th>
 					<th><?php echo $this->lang->line('adjust_6'); ?></th>
 					<th><?php echo $this->lang->line('adjust_7'); ?></th>
 					<th class="none"><?php echo $this->lang->line('adjust_8'); ?></th>
 				</tr>
 			</thead>
 			<tbody class="body-table-sessions">
 				...
 				for ($i = 0; $i < count($users); $i++) {
 					...
 					<tr>
 						...
 						<td><?=$total_weeks_hours[$i]?> <?=$this->lang->line('invoice_19')?></td>
 						<td><?=$total_horas_extras[$i]?> <?=$this->lang->line('invoice_19')?></td>
 						<td><?=$total_horas_break[$i]?> <?=$this->lang->line('invoice_19')?></td>
 						<td class="none"><a href="<?=$url;?>"><?=$this->lang->line('adjust_8');?></a></td>
 					</tr>
 				<?php } ?>
 			</tbody>
 		</table>
