...
for ($i = 0; $i <count($info_user) ; $i++) {
	...
	if ($fecha_pausa->format('Y-m-d H:i:s') != '-0001-11-30 00:00:00' and $fecha_pausa_fin->format('Y-m-d H:i:s') != '-0001-11-30 00:00:00' and $fecha_fin->format('Y-m-d H:i:s') != '-0001-11-30 00:00:00') {
		$hours_worked[$i] = $horas_basica[$i];
		$total_horas += $horas_basica[$i]; 
...
<div class="col-md-12 col-sm-12 col-xs-12" id="titulo" style="font-family: 'Arvo', sans-serif;">
	<h3><?php echo $this->lang->line('adjust_12'); ?></h3><hr>
</div>
	...
	<div class="container-tabla" style="overflow-y: scroll;height: 620px;" id="scroll_container">
			...
			<div class="pull-right" style="margin-bottom: 20px;">
				...
				<form class="form-inline" action="<?=base_url('Admin/Working_detail/'.$user)?>">
					<div class="form-group">
						<label for="date1"><?php echo $this->lang->line('adjust_27'); ?>:</label>
						<script>
							$(function(){
					...
					<div class="form-group">
						<label for="date2"><?php echo $this->lang->line('adjust_26'); ?></label>
					...
					<div class="form-group" style='margin-left:10px;'>
						<button type="submit" class="btn btn-info"><?php echo $this->lang->line('adjust_3'); ?></button>
					</div>
				</form>
		...
		<div class="col-xs-12">
			<div class="col-xs-4 col-xs-offset-1">
				<h4 style="color: #2c2c2d;"><?php echo $this->lang->line('adjust_13'); ?>: <span style="color: #909090;"><?=$info_user[0]->Name." ".$info_user[0]->LastName;?></span></h4>
			</div>
			<div class="col-xs-4">
				<h4 style="color: #2c2c2d;"><?php echo $this->lang->line('adjust_14'); ?>: <span style="color: #909090;"><?php echo $role->Role ?></span></h4>
			</div>
		</div>

		<div class="col-xs-12" style="border: 1px solid #e6e6e6;color: #2c2c2d;width: 993px;margin-left: 46px;">
			<div class="col-xs-3 text-center">
				<h4><?php echo $this->lang->line('adjust_15'); ?></h4>
				<h4><?php echo $this->lang->line('adjust_16'); ?></h4>
				<h4>40.00</h4>
			</div>
			<div class="col-xs-3 text-center">
				<h4><?php echo $this->lang->line('adjust_17'); ?></h4>
				<h4></h4>
				<h4><?=$total_weeks_hours?></h4>
			</div>
			<div class="col-xs-3 text-center">
				<h4><?php echo $this->lang->line('adjust_18'); ?></h4><br>
				<h4><?=$total_horas?></h4>
			</div>
			<div class="col-xs-3 text-center">
				<h4><?php echo $this->lang->line('adjust_19'); ?></h4><br>
			...
			<div class="container_dia">
				<table class="table table-responsive table-striped" align="center">
					<thead class="header-table-sessions2">
						<tr>
							<th><?php echo $this->lang->line('adjust_20'); ?></th>
							<th><?php echo $this->lang->line('adjust_21'); ?></th>
							<th><?php echo $this->lang->line('adjust_22'); ?></th>
							<th><?php echo $this->lang->line('adjust_23'); ?></th>
							<th><?php echo $this->lang->line('adjust_24'); ?></th>
							<th><?php echo $this->lang->line('adjust_25'); ?></th>
							<th></th>
						</tr>
					</thead>
					<?php for ($i = 0; $i <count($info_user) ; $i++) {
						...
						<tbody class="body-table-sessions2">
							...
							<tr>
								...
								<td>
									<input type="text" readonly="" value="<?=$hours_worked[$i]?>">
								</td>
								<td>
