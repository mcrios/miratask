...
$actualURIArray = explode('/', $_SERVER['REQUEST_URI']);
$detailStatus = strpos($actualURI, "/$actualURIArray[1]/Detail" );

if("/$actualURIArray[1]/index.php/Dashboard" == $actualURI
  || "/$actualURIArray[1]/Dashboard" == $actualURI
){
  echo "
  #wrapContent > div:not(#modal-event) {
...
<div id="modal-event" class="sin_flex modal fade modal-mira" role="dialog">
    ...
    <div class="left_col scroll-view">
     ...
     <div class="navbar nav_title" style="border: 0;">
      ...
      <?php if (empty($url) or $url ==" ") {
        ...
        echo '<img src="'.$url.'" alt="logo" style="width:66%;">';
...
<div class="right_col wrapContent centrado" id="wrapContent" role="main">
