	...
	<div class="modal-dialog w700">
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><span class="glyphicon glyphicon-calendar"></span> <?=(isset($event->id)? $this->lang->line('matters_detail_61') : $this->lang->line('matters_detail_62') ) ?> <?php echo $this->lang->line('matters_detail_20'); ?></h4>
			</div>
			<div class="modal-body">
				<div class="panel-event form-events">
					...
					<div class="row">
						<div class="col-xs-3 text-right">
							<label><?php echo $this->lang->line('calendar_17'); ?></label>
						</div>
						<div class="col-xs-8">
					...
					<div class="row">
						<div class="col-xs-3 text-right">
							<label><?php echo $this->lang->line('calendar_18'); ?></label>
						</div>
						<div class="col-xs-8">
					...
					<div class="row">
						<div class="col-xs-3 text-right">
							<label><?php echo $this->lang->line('calendar_19'); ?></label>
						</div>
						<div class="col-xs-8">
					...
					<div class="row">
						<div class="col-xs-3 text-right">
							<label><?php echo $this->lang->line('calendar_20'); ?></label>
						</div>
						<div class="col-xs-3">
					...
					<div class="row">
						<div class="col-xs-3 text-right">
							<label><?php echo $this->lang->line('calendar_21'); ?></label>
						</div>
						<div class="col-xs-3">
						...
						<div class="row">
							...
							<div class="col-xs-8">
								<input type="checkbox" id="allday" name="allday" value="1" <?=isset($event->all_day) && $event->all_day==1? 'checked' : '' ?> /> <?php echo $this->lang->line('calendar_22'); ?>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-3 text-right">
								<label><?php echo $this->lang->line('calendar_23'); ?></label>
							</div>
							<div class="col-xs-8">
				...
				<div class="row">
					<div class="col-xs-11 text-right">
						<input type="button" id="cancel" name="" style="width: 150px" value="<?php echo $this->lang->line('calendar_24'); ?>" class="btn  btn-primary" data-dismiss="modal" />
						<input type="submit" id="save_close" name="" style="width: 150px" value="<?php echo $this->lang->line('calendar_25'); ?>" class="btn  btn-primary" />
					</div>
				</div>
			</div>
		</div>
