...
<style type="text/css">
 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3><?php echo $this->lang->line('document_1'); ?></h3><hr>
 </div>
 ...
 <div class="row">
 	...
 	<div class="matterContent">
 		...
 		<div class="col-xs-3 folderNav">
 			...
 			<!-- Folders cat  -->
 			<div id="folders_tree" class="tabcontent matCat my-scroll"   <?=$display1?> >
 		...
 		<div class="col-xs-9 ListWrap">
 			<form name ="listForm" id="listForm" action="<?=base_app()?>Document/eraseListConfirm" method="POST" >
 				...
 				<div class="col-xs-12  buttWrap">
 					...
 					<div class="col-md-3 pl0">
 						<a id="add_matters"   class="btn btn-primary btn-lg btn-block" onclick="newFolder()" >
 							<i class="fa fa-plus"></i> &nbsp; <?php echo $this->lang->line('document_4'); ?>
 						</a>
 					</div>
 					...
 					<div class="btn-group ml-2 listButtWrap">
 						<button id="abc" type="button" class="btn btn-lg btn-secondary"><?php echo $this->lang->line('document_6'); ?></button>
 						<button type="button" class="btn btn-secondary dropdown-toggle caret2" data-toggle="dropdown">
 							<span class="caret"></span>
 						</button>

 						<ul class="dropdown-menu btn-block" role="menu">
 							<li onclick="newDocument()"><?=$this->lang->line('document_28')?></li>
 					...
 					<div class="btn-group ml-2 listButtWrap">
 						<button id="abc" type="button" class="btn btn-lg btn-secondary"><?php echo $this->lang->line('document_7'); ?></button>
 						<button type="button" class="btn btn-secondary dropdown-toggle caret2" data-toggle="dropdown">
 							<span class="caret"></span>
 						</button>

 						<ul class="dropdown-menu btn-block" role="menu">
 							<li onclick="atachTo('AjaxDoc/MoveTo')"><?=$this->lang->line('document_29')?></li>
 							<li onclick="atachTo('AjaxDoc/atachTo')"><?=$this->lang->line('document_30')?></li>
 					...
 					<!-- boton " Delete" -->
 					<div class="col-md-3">
 						<input type="submit" id="delete_matters"  class="btn fa-trash btn-block" value="&#xf1f8; <?=$this->lang->line('document_5')?>" style="font-family:Arvo, FontAwesome" />
 					</div>
 				...
 				<div class="col-xs-12">
 					...
 					<div class="print">
 						<p><?php echo $this->lang->line('document_1'); ?></p> <span onclick="printTMatters()" class="fa fa-print"></span>
 					</div>
 				</div>
 				...
 				<div class="col-md-12">
 					...
 					<div class="paginationWrap col-xs-3" > 
 						...
 						<div class="resxP col-md-4">
 							<span class="l"><?php echo $this->lang->line('document_8'); ?> &nbsp;</span>
 							
 							<button   type="button" class="btn btn-default btn-xs br0 l" data-toggle="dropdown">
 								
 								<?php echo $this->lang->line('main_7'); ?>
 								<span class="caret"></span>
 					...
 					<div id="resultTable">
 						<table  class="table table-bordered table-inverse">
 							<thead>
 								<tr>
 									<th> </th>
 									<th><?php echo $this->lang->line('document_9'); ?></th>
 									<th><?php echo $this->lang->line('document_10'); ?></th>
 									
 									<th><?php echo $this->lang->line('document_11'); ?></th>
 									<th><?php echo $this->lang->line('document_12'); ?></th>
 									<th><?php echo $this->lang->line('document_13'); ?></th>
 							...
 							<tbody>
 								...
 								foreach ($Document as $row){ 
 									...
 									<tr>
 										...
 										?>
 										<td>
 											<a href="<?=base_url()?><?php echo $ruta.$row->FileName?>" target="_blank">
 												&nbsp;  <?=$Icon?> &nbsp; 
 											</a>	
