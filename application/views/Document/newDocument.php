  ...
  <head>
    ...
    <!-- Fine Uploader Gallery template
    	...
    	<script type="text/template" id="qq-template-gallery">
    		<div class="qq-uploader-selector qq-uploader qq-gallery" qq-drop-area-text="<?php echo $this->lang->line('document_26'); ?>">
    			...
    			<div class="qq-upload-button-selector qq-upload-button">
    				<div><?php echo $this->lang->line('document_25'); ?></div>
    			</div>
    ...
    <body>
    	...
    	<div id=" " class="col-md-12 boxSlider">
    		...
    		<div class="BoxtitleGray">
    			<img src="<?=base_url()?>img/gray_folder.png"> &nbsp; <?php echo $this->lang->line('document_19'); ?>  <span onclick="CloseObject('newFolder')" >X</span>
    		</div>
    		...
    		<div class="TaskallInputWrap allInputContainer">
    			...
    			<form id="formNewDocs">
    				...
    				<div class="form-group row btn-group ml-2  " >
    					...
    					<label><?php echo $this->lang->line('document_20'); ?> </label> 



    					<div class="btn-group ml-2  foldWrap" >
    						<div id="folderSelector"   class="largeselect"  style="margin-left:25px;" ><?php echo $this->lang->line('document_20'); ?></div>
    				...
    				<div class="form-group row btn-group ml-2  ">
    					...
    					<label><?php echo $this->lang->line('document_21'); ?></label> 

    					<input id="EstimatedTime" class="largeselect" value="" onkeyup="ContactAndMAtt(this.value,'_A')" placeholder="<?php echo $this->lang->line('document_22'); ?> " type="text"> 
    					...
    					<div id="ButtonsWrapBox_A" class="ml125">
    						...
    						<?php if($actualMatter!='undefined'){ 
    							...
    							<span id="ContMAtterButt38" class="staffItem  btn btn-default btn-xs"> 
                                    ...
                                    <input type="hidden" name="ContMAtter_A[]" value="<?=$actualMatter->Id?>_matter">
                        ...
                        <div class="form-group row btn-group ml-2">
                          ...
                          <label><?php echo $this->lang->line('document_23'); ?></label> 

                          <textarea id="Description" name="Description" type="textarea" class="largeselect" placeholder="<?php echo $this->lang->line('document_24'); ?>"></textarea>
                      </div>
