...
<div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
	<h3><?php echo $this->lang->line('billing_13'); ?></h3><hr>
</div>
...
<div class="row">
	...
	<div class="matterContent">
		...
		<div class="col-xs-9 ListWrap">
			...
			<div class="col-xs-12  landingbuttWrap tex">
				<!-- boton " + add Matters"-->

				<li class="col-md-3  ml0i col-md-offset-2">
					$<?=number_format ( $Estadistic->Paid , 2 , "." , "," )?>
					<div><?php echo $this->lang->line('billing_7'); ?></div>
				</li>

				<li class="col-md-3 cred">
					$<?=number_format ( $getEstadisticOverdue->Overdue , 2 , "." , "," )?>
					<div><?php echo $this->lang->line('billing_8'); ?></div>
				</li>

				<li class="col-md-3   cgreen">
					$<?=number_format ( $PaidLast30days->PaidLast30days , 2 , "." , "," )?>
					<div><?php echo $this->lang->line('billing_9'); ?></div>
				</li>

				<!--<li class="col-md-2  cyellow">
					$<?=number_format ( $Estadistic->Invoiced , 2 , "." , "," )?>
					<div><?php echo $this->lang->line('billing_10'); ?></div>
				</li>-->
			...
			<div class="col-md-12 shadowWrap">
				...
				<div class="titleBillDsh">
					<?php echo $this->lang->line('billing_6'); ?>
				</div>
				...
				<div class="BarsWrap">
					...
					<li style="padding-top:<?=100-$height?>px;">
						...
						<a href="<?=base_url('Billing/Aging/0')?>">	
					...
					<li style="padding-top:<?=100-$height1?>px;">
						...
						<a href="<?=base_url('Billing/Aging/1')?>">	
					...
					<li style="padding-top:<?=100-$height2?>px;">
						...
						<a href="<?=base_url('Billing/Aging/30')?>">	
					...
					<li style="padding-top:<?=100-$height3?>px;">
						...
						<a href="<?=base_url('Billing/Aging/60')?>">	
					...
					<li style="padding-top:<?=100-$height4?>px;">
						...
						<a href="<?=base_url('Billing/Aging/90')?>">
		...
		<div class="invoicedwrap col-md-12 ">
			<li>
				<div class="x_title"> <img src="<?=base_url()?>img/Billing_blue.png" /> <?php echo $this->lang->line('billing_11'); ?></div>
			...
			<li class="ml30">
				<div class="x_title"> <img src="<?=base_url()?>img/Billing_blue.png" /> &nbsp; <?php echo $this->lang->line('billing_12'); ?></div>
				<table class="table table2      ">
