...
<body>
	...
	<div class="body_conten">
		...
		<div class="info">
			<div class="vineta firstv">
				...
				<?php if($inv_setting[6]->estado=='OK'){ ?>
					<?php echo $this->lang->line('contacts_8'); ?>: <?=$inv_setting[6]->valor?><br>
			...
			<div class="vineta lastv">
				<h3>&nbsp;</h3>
				<strong><?php echo $this->lang->line('billing_43'); ?>:</strong> <?=$Invoice->Number?><br>
				<strong><?php echo $this->lang->line('billing_46'); ?>:</strong> <?=decodedate($Invoice->InvoiceDate)?><br>
				<strong><?php echo $this->lang->line('Billing_Code_7'); ?>:</strong> <?=decodedate($Invoice->DueDate)?><br>
				<strong><?php echo $this->lang->line('Billing_Code_8'); ?>:</strong><?=$Matter->Name?><br>
			</div>
		...
		<div class="detallesWrap">
			...
			<div class="dtitle">			
				<?php echo $this->lang->line('invoice_13'); ?>
			</div>
			<table  class="table2">
				<thead>
					<tr>
						...
						<th><?=$this->lang->line('invoice_47')?></th>
			...
			<table  class="table table-bordered table-inverse">
				<thead>
					<tr>
						...
						<th><?=$this->lang->line('matters_detail_23')?></th>
						<th><?php echo $this->lang->line('billing_31'); ?></th>
						<th><?php echo $this->lang->line('invoice_16'); ?></th>
			...
			<div class="totales">
				...
				<table class="totalesTable">
					...
					<?php if(count($Expense)>0){ ?>
						<tr style="border-bottom:1px solid #FFF">
							<td><?php echo $this->lang->line('billing_31'); ?> subtotal</td>
							<td>
					...
					<tr style="border-bottom:1px solid #FFF">
						...
						<td>
							...
							$<span id="totDesc"><?=(($Invoice->DiscServices+$Invoice->DiscExpenses)>0?$Invoice->DiscServices+$Invoice->DiscExpenses:"0.00")?></span>
						</td>
					</tr>
					...
					<tr class="tfooter">
						...
						<td>
							...
							$ <span id="s"><?=(($Invoice->Status=='Paid')?'0.00':$totalTimes+$totalExpense-$Invoice->DiscPart+(($Invoice->TaxValue/100)*$totalExpense))?></span>
							...
							<script type="text/javascript">
								...
								if(taxPorc=="" || taxPorc==undefined){ taxPorc = 0.00; }
