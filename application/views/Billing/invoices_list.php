 		...
 		<div class="col-xs-12  buttWrap">
 			...
 			<div class="col-md-3 pl0">
 				<a id="add_matters"   class="btn btn-primary btn-lg btn-block" onclick="new_invoice()" >
 					<i class="fa fa-plus"></i> &nbsp; <?=$this->lang->line('billing_39');?>
 				</a>
 			</div>
 			...
 			<div class="col-md-3">
 				<a id="delete_matters" onclick="slideDown('form-print')"  class="btn   btn-block" > <?=$this->lang->line('billing_40')?></a>
 			</div>

 			<!-- boton " Delete Matters" -->
 			<div class="col-md-3">
 				<a id="delete_matters" href="<?=base_app()?>Billing/setCriterioInvoices"  class="btn   btn-block" >  <?=$this->lang->line('billing_41')?> </a>
 			</div>


 			<div class="col-md-3">
 				<input   type="text" class="Mediumselect" onkeyup="MatterRelToInvoice(this.value)" placeholder="<?=$this->lang->line('billing_42')?>" value="<?=$this->session->userdata("matterCriterioActual")?>"> 
 	...
 	<div class="form-group container-form-print" id="form-print">
 		<div class="col-xs-3 col-xs-offset-5">
 			<div class="form-group">
 				<label for="date1"><?php echo $this->lang->line('list_1'); ?>: </label>
 				<input type="date" class="form-control" name="date1" id="date1" value="<?=$date1?>" max="<?=$date2?>">
 			</div>
 		</div>
 		<div class="col-xs-3">
 			<div class="form-group">
 				<label for="date2"><?php echo $this->lang->line('list_2'); ?>: </label>
 	...
 	<div class="col-md-12">
 		...
 		<div class="paginationWrap" > 
 			...
 			<div class="resxP col-md-4">
 				<span class="l"><?=$this->lang->line('billing_38')?>: &nbsp;</span>
