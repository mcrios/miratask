...
<!-- CONTENIDO Contacts -->
 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
	<h3><?php echo $this->lang->line('billing_5'); ?></h3><hr>
 </div>
		...
		<div class="col-xs-9 ListWrap">			
			<form name ="listForm" id="listForm"  action="<?=base_app()?>Billing/changeStatusList" method="POST" >
					...
					<div class="col-xs-12  buttWrap">
						...
						<div class="col-md-3 pl0">
							<a id="add_matters"   class="btn btn-primary btn-lg btn-block" onclick="new_billingcode()" >
								<i class="fa fa-plus"></i> &nbsp; <?php echo $this->lang->line('Billing_Code_1'); ?>
							</a>
						</div>
						...
						<!-- boton " Delete Matters" -->
						 <div class="col-md-3 pl0">
							<a type="button" id="add_matters"  class="btn  act btn-lg btn-block"     ><?php echo $this->lang->line('Billing_Code_2'); ?></a>
						</div> 
						<div class="col-md-3 pl0">
							<a type="button" id="add_matters"  class="btn deact btn-lg btn-block"    ><?php echo $this->lang->line('Billing_Code_3'); ?></a>
						</div> 
				...
				<div class="col-xs-12">
					...
					?>	
					<div class="print">
						<p><?php echo $this->lang->line('billing_5'); ?> </p> <span onclick="printTMatters()" class="fa fa-print"></span>
					</div>
				</div>
				...
				<div id="resultTable">
					<table class="table table-bordered table-inverse">
						<thead>
							<tr>
								<th></th>
								<th><?php echo $this->lang->line('Billing_Code_4'); ?></th>
								<th><?php echo $this->lang->line('Billing_Code_5'); ?></th>
								<th><?php echo $this->lang->line('Billing_Code_6'); ?></th>
								<!--<th>invoice Date</th>
								<th>Due Date</th>
								<th>Matter</th>
								<th>Balance</th>
