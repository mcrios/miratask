...
<?php endif; ?>
<?php if ($this->input->get('invoice') && $this->input->get('invoice')!=''): ?>
<input type="hidden" id="" name="noinvoice" value="<?=$this->input->get('invoice')?>">
<?php endif; ?>
	...
	<div class="modal-content" style="">
		<div class="modal-header">
			...
			<h4 class="modal-title">
				...
				<?=(isset($entry->id)? $this->lang->line('matters_detail_61') : $this->lang->line('matters_detail_62') ) ?> <?php echo $this->lang->line('matters_detail_63'); ?>
		...
		<div class="modal-body no-padding">
			<div class="tabs-modal">
				...
				<div class="tab-modal <?=(!isset($entry->type_entry) || (isset($entry->type_entry) && $entry->type_entry=="TIME")) ? "active":"" ?>" target="tab-time">
					...
					<?php echo $this->lang->line('billing_30'); ?>
				...
				<div class="tab-modal <?=(isset($entry->type_entry) && $entry->type_entry=="EXPENSE") ? "active":"" ?>" target="tab-expense">
					...
					<?php echo $this->lang->line('billing_31'); ?><input type="radio" name="type_entry" value="EXPENSE" style="display: none" <?=(isset($entry->type_entry) && $entry->type_entry=="EXPENSE") ? "checked":"" ?> />

				</div>

				<?php if($statusMostrar=="mostrar"): ?>
				<div class="tab-modal <?=(isset($entry->type_entry) && $entry->type_entry=="RANGE") ? "active":"" ?>" target="tab-range">

					<img src="<?=base_url()?>img/time_icon_button.png">

					<?php echo $this->lang->line('billing_32'); ?> <input type="radio" name="type_entry" value="RANGE" style="display: none" <?=(isset($entry->type_entry) && $entry->type_entry=="RANGE") ? "checked":"" ?> />
...
?>
					<div id="contorno" class="col-md-12">
						...
						<div class="forms">
							<div class="panel-body">
								<p><?php echo $this->lang->line('billing_33'); ?></p>
							</div>
						</div>
						<br>
							...
							<div class="form-group row">
								...
								<div class="col-md-6">
									<form class="form-horizontal" action="#" id="form-new-billing">
										...
										<label for="" name="id" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_24'); ?>  </label>
									...
									<div class="col-md-6">
										<label for="" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_25'); ?></label>
										<div class="input-group">
											<span class="input-group-addon">
												<span class="glyphicon glyphicon-usd"></span>
											</span>
										...
										<label for="" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_26'); ?></label>
								...
								<div class="form-group row">	
									...
									<div class="col-md-6">
										<label for="" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_27'); ?></label>
									...
									<div class="col-md-6">
										<label for="" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_28'); ?></label>
									...
									<div class="form-group row">		
										<div class="col-md-6">					
											<label for="" class="col-sm-1 col-form-label"><?php echo $this->lang->line('billing_29'); ?></label>
									...
									<div class="form-group row fitButtons">
										...
										<div class="col-md-3">
											<input  id="save_close" type="button" value="<?php echo $this->lang->line('document_17'); ?>" class="btn btn-primary btn-lg btn-block"> 
										</div>

										<div class="col-md-3">
											<a href="<?=base_app()?>Matters" id="cancel" type="button" class="btn btn-primary btn-lg btn-block"> <?php echo $this->lang->line('document_18'); ?>
			...
			<div class="body-tabs-modal-container">
				...
				<div class="row">
					<div class="col-xs-2 text-right">
						<label><?php echo $this->lang->line('billing_14'); ?></label>
					</div>
					<div class="col-xs-4">
						<select class="form-control" name="billing_code">
							<option value="-1"><?=$this->lang->line('billing_57') ?></option>
					...
					<div class="col-xs-2 text-right">
						<label><?php echo $this->lang->line('billing_15'); ?></label>
					</div>
					<div class="col-xs-4">
				...
				<div class="row">
					<div class="col-xs-2 text-right">
						<label><?php echo $this->lang->line('billing_16'); ?></label>
					</div>
					<div class="col-xs-4">
			...
			<div class="col-xs-2 text-right">
				<label><?php echo $this->lang->line('billing_17'); ?></label>
			</div>
			<div class="col-xs-4">
		...
		<div class="row">
			<div class="col-xs-2 text-right">
				<label><?php echo $this->lang->line('billing_18'); ?></label>
			</div>
			<div class="col-xs-10">
		...
		<div class="bg-shadow for-time">
			<div class="row">
				<div class="col-xs-2 text-right">
					<label><?php echo $this->lang->line('billing_19'); ?></label>
				</div>
				<div class="col-xs-4">
					<select class="form-control" name="is_flat_fee">
						<option <?=(isset($entry->is_flat_fee)&& $entry->is_flat_fee==0)? "selected" :"" ?> value="0"><?php echo $this->lang->line('modal_time_1'); ?></option>
						<option <?=(isset($entry->is_flat_fee)&& $entry->is_flat_fee==1)? "selected" :"" ?> value="1"><?php echo $this->lang->line('modal_time_2'); ?></option>
					</select>
				</div>
				<div class="col-xs-2 text-right">
					<label class="fee-label"><?php echo $this->lang->line('billing_20'); ?></label>
				</div>
				<div class="col-xs-4">
			...
			<div class="row no-fee" <?=(isset($entry->is_flat_fee)&& $entry->is_flat_fee==1)? "style='display:none'" :"" ?>>
				<div class="col-xs-2 text-right">
					<label><?php echo $this->lang->line('billing_21'); ?></label>
				</div>
				<div class="col-xs-4">
					<input onClick="max_time()" type="number" id="horas" name="units" value="<?=_v($entry->units) ?>" placeholder="" class="form-control autocalcule-time"  step="0.01" />
					<br />
				...
				<div class="col-xs-2 text-right">
					<label><?php echo $this->lang->line('billing_22'); ?></label>
				</div>
				<div class="col-xs-4">
		...
		<div class="row">
			<div class="col-xs-2 text-right">
				<label><?php echo $this->lang->line('billing_23'); ?></label>
			</div>
			<div class="col-xs-10">
		...
		<div class="text-right">
			<input type="button" id="cancel" name="" style="width: 150px" value="<?php echo $this->lang->line('document_18'); ?>" class="btn  btn-primary" data-dismiss="modal" />
			<?php if($sendViaAjax=='si'){ ?>   
				<input type="button" id="save_close"  onclick="savetime()" name="" style="width: 150px" value="<?php echo $this->lang->line('document_17'); ?>" class="btn  btn-primary" />
			<?php }else{?>
				<input type="submit" id="save_close" name="" style="width: 150px" value="<?php echo $this->lang->line('document_17'); ?>" class="btn  btn-primary" />
			<?php }?>	
		</div>
	</div>
...
<script type="text/javascript">
	...
	$('[name="is_flat_fee"]').change(function(){
		if($(this).val()==1){
			is_flat_fee=true;
			$(".fee-label").text("<?php echo $this->lang->line('billing_26'); ?>");
			$(".no-fee").hide();
		}else{
	...
	$(".autocalcule-time").change(function(){
		...
		if(!is_flat_fee){
			...
			var horas = units.split(".")[0];
			var minutos = units.split(".")[1];
			...
			for(var i = 1; i <10; i++ ){
				if(minutos == ( "" + i +"" ) ){
					minutos = ( "" + i + "" + "0" );
					console.log("conversion: " + minutos);
				}
			}
			...
			// REGLA DE TRES: minutos por 100 entre 60
			// EL RESULTADO ES LOS MINUTOS ESCALADOS A 100
			// EN LA ESCALA DE 100 SE DIVIDE ENTRE 100 PARA SACAR %
			if(minutos >= 60 ){
				minutos=59;
			}
			
			total = (horas * rate) +  ( minutos * 100 / 60 /100 * rate ) ;
