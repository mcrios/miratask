 			...
 			<form   action="<?=base_app()?>User/update/<?=$user->Id?>" method="POST" id="contactList" >
 				...
 				<div class="col-xs-12  buttWrap">
 					...
 					<div class="col-md-3 pl0">
 						...
 						<?php 
 						if($user->State==1){
 							$label=$this->lang->line('add_user_12');
 						}elseif($user->State==2){
 							$label=$this->lang->line('add_user_13');
 						} 
 						?>
 					...
 					<div class="addUserInputWrap">
 						...
 						<table class="addUser">
							...
							<tr>
								...
								<td>
									<div class="role"><input type="radio" value="1" name="Role" id="Role" <?php echo $user->Role == "1" ? "checked":""?>> <?php echo $this->lang->line('add_user_7'); ?>   </div>
									<div class="role"><input type="radio" value="2" name="Role" id="Role" <?php echo $user->Role == "2" ? "checked":""?>> <?php echo $this->lang->line('add_user_8'); ?></div>
									<div class="role"><input type="radio" value="3" name="Role" id="Role" <?php echo $user->Role == "3" ? "checked":""?>> <?php echo $this->lang->line('add_user_9'); ?>   </div>
								</td>
							</tr>
							<tr>
								<td> 
