 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3><?=$this->lang->line('user_0')?></h3><hr>
 </div>
 	...
 	<div class="matterContent">
 		...
 		<div class="col-xs-9 ListWrap">		
 			...
 			<form   action="<?=base_app()?>Contacts/eraseListConfirm" method="POST" id="contactList" >
 				...
 				<div class="col-xs-12  buttWrap">
 					...
 					<div class="col-md-3 pl0">
 						<a id="add_matters" href="<?=base_url()?>User/addForm" class="btn btn-primary btn-lg btn-block" >
 							<i class="fa fa-plus"></i> &nbsp; <?=$this->lang->line('user_5')?>
 						</a>
 					</div>
 				...
 				<div class="col-xs-12">
 					<div class="print">
 						<p><?=$this->lang->line('user_2')?></p> <span onclick="printTMatters()"  class="fa fa-print  fa-2x"  ></span>
 					</div>
 				</div>
 					...
 					<div id="resultTable"> 
 						...
 						<table class="table table-bordered table-inverse">
 							<thead>
 								<tr>
 									<!-- <th> </th> -->
 									<th><?=$this->lang->line('user_6')?></th>
 									<th><?=$this->lang->line('user_7')?></th>
 									<th><?=$this->lang->line('user_8')?></th>
 									<th><?=$this->lang->line('user_9')?></th>
 									<th><?=$this->lang->line('user_10')?></th>
 									<th><?=$this->lang->line('user_11')?></th>
 								</tr>
 							</thead>
