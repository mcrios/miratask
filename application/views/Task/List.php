 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3><?php echo $this->lang->line('task_1'); ?></h3><hr>
 </div>
 ...
 <div class="row">
 				...
 				<div class="col-xs-12  buttWrap">
 					...
 					<div class="col-md-2 pl0">
 						<a id="add_matters"   class="btn btn-primary btn-lg btn-block" onclick="createTask('','')" >
 							<i class="fa fa-plus"></i> &nbsp; <?php echo $this->lang->line('task_2'); ?>
 						</a>
 					</div>
 					...
 					<div class="col-md-2">
 						<input type="submit" id="delete_matters"  class="btn fa-trash btn-block" value="&#xf1f8; <?php echo $this->lang->line('task_3'); ?>" style="font-family:Arvo, FontAwesome" />
 					</div>

 					<div class="col-md-2 pl0">
 						<a id="close_matter"  class="btn btn-block" >
 							<i class="fa fa-plus"></i> &nbsp;<?php echo $this->lang->line('task_4'); ?>
 						</a>
 					</div>
 					
 					<div class="col-md-2 pl0">
 						<a onclick="atachTo('Ajax/atachTo')" id="add_matters"   class="btn btn-primary btn-lg btn-block" >
 							<i class="fa fa-plus"></i> &nbsp; <?php echo $this->lang->line('task_5'); ?>
 						</a>
 					</div>
 					...
 					<div class="col-md-2 pl0">
 						<a class="boton_filtro btn " onclick="switchx('filtro_wrap')">
 							<img src="<?=base_url()?>img/filtro.png" > <?php echo $this->lang->line('task_6'); ?>
 						</a>
 					</div>
 					...
 					<div class="col-md-2 pl0">
 						...
 						<a class="boton_filtro btn ">
 							<input type="checkbox" style="margin-top"  name="showCompleted"  id="showCompleted" <?=$chek?> value=""> <?php echo $this->lang->line('task_7'); ?>
 						</a> 
 					</div>
 				...
 				<div class="filtro_wrap TaskallInputWrap" id="filtro_wrap" style='display:none' >
 					...
 					<div class="col-md-5" style="padding-left: 0px !important;">
 						...
 						<button id="AssignButt" type="button" class="shortSelect" style="width:157px !important;" >
 							...
 							<?=($AtorneyName=="")?$this->lang->line('matters_detail_25'):$AtorneyName?>
 					...
 					<div class="col-md-5">
 						...
 						<button id="PriorityButt" type="button" class="shortSelect" ><?=($PriorityName->Name=="")?$this->lang->line('days_4'):$PriorityName->Name?></button>
 					...
 					<div class="col-md-5">
 						...
 						<button id="CategoryButt" type="button" class="shortSelect" ><?=($categoryName->Name=="")?$this->lang->line('task_14'):$categoryName->Name?></button>
 					...
 					<div class="col-md-5">
 						...
 						<button id="StatusButt" type="button" class="shortSelect" ><?=($StatusName->Name=="")?$this->lang->line('task_21'):$StatusName->Name?></button>
 					...
 					<div class="col-md-5"> <!-- fecha uno -->
 						...
 						<input type="text" placeholder="<?=$this->lang->line('task_35')?>" name="StartTime" id="StartTime" value="<?=$this->session->userdata('taskfilStartTime')?>" class="shortSelect"  />
 					...
 					<div class="col-md-5">
 						...
 						<input  id="EndTime"  placeholder="<?=$this->lang->line('task_36')?>"  type="text"   name="EndTime" value="<?=$this->session->userdata('taskfilEndTime')?>" class="shortSelect"  />
 					...
 					<div class="col-md-5" style="padding-left: 0px !important;  margin-top:10px;" id="ButtonsWrapBox_A">
 						...
 						<input   type="text" class="shortSelect" style="width:190px !important;" onkeyup="ContactAndMAtt(this.value,'_A')" placeholder="<?=$this->lang->line('document_22')?>"> 
 					...
 					<div class="col-xs-12">
 						...
 						<div class="print">
 							<p><?php echo $this->lang->line('dashboard_2'); ?> </p> <span onclick="printTMatters()" class="fa fa-print"></span>
 						</div>
 					</div>
 						...
 						<div id="resultTable">
 							<table  class="table table-bordered table-inverse">
 								<thead>
 									<tr>
 										<th> </th>
 										<th><?php echo $this->lang->line('task_9'); ?></th>
 										<th><?php echo $this->lang->line('task_10'); ?></th>
 										
 										<th><?php echo $this->lang->line('task_11'); ?></th>
 										<th><?php echo $this->lang->line('task_12'); ?></th>
 										<th><?php echo $this->lang->line('task_13'); ?></th>
 										<th><?php echo $this->lang->line('task_14'); ?></th>
 										<th><?php echo $this->lang->line('task_15'); ?></th>
 									</tr>
 								</thead>
							...
							//$relatedStaff = $this->TaskModel->relatedStaff($row->Id);
 										...
 										<tr>
 											...
 											<td>
 												<?=traducirPrioridad($this->lang->line('main_9'),$Priority->Name)?> 
 											</td>
 											<td><?=$row->EstimatedHours?></td>
 											<td><?=traducirStatus($this->lang->line('main_9'),$Status->Status)?></td>	
 											<td><?=$Category->Name?></td>
 	...
 	<!-- MODAL -->
<div id="closeTaskModal" class="modal" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tareas a marcar como completas:</h5>
      ...
      <div class="modal-footer">
        <button id="closeTaskBtn" type="button" class="btn btn-primary">Marcar</button>
