...
<form id="formNewTask" method="post" >
	...
	<div   class="col-md-12 boxSlider">
		<div class="Boxtitle"><?php echo $this->lang->line('task_2'); ?><span class="close" onclick="CloseObject('taskForm')">x</span> </div>

		<div class="taskheadButtons btn-group ml-2">


			<a id="MarkComplete" style="background:#dfdfdf; cursor: no-drop;  "  >
				<?php echo $this->lang->line('task_16'); ?>
			</a>
			<input type="hidden" name="Category" id="Category" value="" /> 
			<buttom type="buttom" id="CategoryButt"     data-toggle="dropdown" >

				<?php echo $this->lang->line('task_17'); ?>
			...
			<a id="addtime" onclick="add_entry(0)">
				<?php echo $this->lang->line('task_18'); ?>
			</a>
		...
		<div class="TaskallInputWrap">
			...
			<div class="form-group row btn-group ml-2">
				...
				<label> <?php echo $this->lang->line('task_19'); ?> </label> 
			...
			<div class="form-group row">
				<div class="shortSelectWrap1 btn-group ml-2">
					...
					<label><?php echo $this->lang->line('task_20'); ?></label> 
				...
				<div class="shortSelectWrap2 btn-group ml-2">
					...
					<button id="StatusButt" type="button" class="shortSelect" ><?=$this->lang->line('task_32')?></button>
			...
			<div class="form-group row btn-group ml-2">
				...
				<label><?php echo $this->lang->line('task_22'); ?></label> 

				<button id="AssignButt" type="button" class="largeselect" ><?=$this->lang->line('task_33')?></button>
		...
		<div class="form-group row">
			<div class="shortSelectWrap1 btn-group ml-2">
				...
				<label><?php echo $this->lang->line('task_23'); ?></label> 
			...
			<div class="shortSelectWrap2 btn-group ml-2">
				...
				<label><?php echo $this->lang->line('task_24'); ?></label> 
		...
		<div class="form-group row btn-group ml-2">
			<label><?php echo $this->lang->line('task_25'); ?></label> 
			...
			<input id="EstimatedTime" name="EstimatedTime" type="text" class="largeselect" > 
				...
				<div class="form-group row btn-group ml-2  ">
					...
					<label><?php echo $this->lang->line('task_26'); ?></label> 


					
					<input id=""  type="text" class="largeselect" value="" onkeyup="ContactAndMAtt(this.value,'_A')" placeholder="<?php echo $this->lang->line('task_27'); ?> "> 
					...
					<div class="form-group row btn-group ml-2">
						...
						<label><?php echo $this->lang->line('task_28'); ?></label> 

						<textarea id="Description" name="Description" type="textarea" class="largeselect" placeholder="<?php echo $this->lang->line('task_29'); ?>"></textarea>
					</div>
					...
					<div class="form-group row fitButtons ">
						...
						<div class="col-md-3">
							<a  id="save"  onclick="saveTask()" class="btn btn-primary btn-lg btn-block"><?=$this->lang->line('task_30')?> <img id="lodimg" src="<?=base_url()?>img/loading_blue.gif"></a> 
						</div>
