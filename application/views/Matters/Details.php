 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3><?php echo $this->lang->line('matters_detail_1'); ?></h3>
 	<hr>
 </div>
 ...
 <div class="row">
 	<div class="matterContent">
 		...
 		<div class="col-md-2">
 			<a id="back_matter" href="<?=base_app()?>Matters"   class="btn btn-primary btn-lg btn-block"> <?php echo $this->lang->line('matters_detail_2'); ?></a>
 		</div>


 		<div class="col-md-2">
 			<a id="close_matter" onclick="atachTo('Ajax/CloseMatter/<?=$actualMatter?>')" class="btn btn-primary btn-lg btn-block"> <?php echo $this->lang->line('matters_detail_3'); ?></a>
 		</div>

 		<div class="col-md-2">
 			<a id="delete_matters"  href="<?=base_app()?>Matters/eraseMatterConfirm/<?=$actualMatter?>" class="btn btn-primary btn-lg btn-block"><i class="fa fa-trash"></i><?php echo $this->lang->line('matters_detail_4'); ?></a>
 		</div>
			...
			<div class="col-md-9" id="matters_details">
				...
				<div id="detail_matter" class="x_content">
					<div class="tabPanelWrap" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="opciones" class="nav nav-tabs bar_tabs" role="tablist">
							<li id="tab1" class="tabLink2"><a href="#mcontenido1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"> <i class="fa fa-balance-scale"></i><?= $this->lang->line('matters_detail_5') ?></a></li>
							<!-- <li id="tab2" class="tabLink2"><a href="#tcontenido2" role="tab" data-toggle="tab"><i class="fa fa-check-square-o"></i> Check List</a></li> -->
							<li id="tab3" class="tabLink2 active"><a href="#tcontenido3" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-list-alt"></i><?php echo $this->lang->line('matters_detail_6'); ?></a></li>
							
							<li id="tab4" class="tabLink2"><a href="#tcontenido4" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-sticky-note-o"></i> <?php echo $this->lang->line('matters_detail_7'); ?></a></li>
							...
							<li id="tab6" class="tabLink2"><a href="#tcontenido6" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-sticky-note-o"></i> <?php echo $this->lang->line('matters_detail_8'); ?></a></li>
				...
				<div id="content_meetings_appointments" class="tab-content">
					...
					<!-- contenido 1 -->
					<div role="tabpanel" class="tab-pane fade  in" id="mcontenido1" aria-labelledby="home-tab">
						...
						<div class="col-md-12">
							...
							<div class="tab">
								<button class="tablinks Mbasic active" onclick="openCity(event, 'Matterbasic')"><?php echo $this->lang->line('matters_52'); ?></button>
								<button class="tablinks Intake" onclick="openCity(event, 'IntakeDetails')"><?php echo $this->lang->line('matters_53'); ?></button> 
							</div>
							...
							<form class="form-horizontal" role="form" id="form_details" method="post" action="<?=base_app()?>Matters/Update/<?=$actualMatter?>">	
								...
								<div id="Matterbasic" class="tabcontent active" style="display:block">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_detail_14'); ?><span class="required">*</span></label>
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_19'); ?> <span class="required"> </span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_7'); ?> <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<?php 
											...
											//echo "</pre>";
											?>
											<input type="text"  value="<?=($ClientName->FirstName!=''?$ClientName->FirstName." ".$ClientName->Middle." ".$ClientName->LastName."  ".$ClientName->Suffix:$ClientName->Company)?>" name="Contact_A" onkeyup="showContacts(this.value,'_A')" required="required" class="form-control SS" placeholder="<?php echo $this->lang->line('matters_22'); ?>" style="font-family:Arial, FontAwesome">
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<button type="button" class="btn btn-primary btn-lg btn-block" onclick="createContact('ContactID_A','Contact_A')"> 
												...
												<?php echo $this->lang->line('matters_23'); ?>
											</button>
										</div>
									</div>
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_detail_38'); ?></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<!-- ohter staff --> 
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_29'); ?> <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<input type="text" name="OtherStaff" onkeyup="showAtorneys(this.value)" value=""  class="form-control" autocomplete="off" placeholder="<?php echo $this->lang->line('matters_30'); ?>" />
											<div id="staffWrapBox">
												<?php 
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_detail_40'); ?> <span class="required">*</span></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="input-group">
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_26'); ?> </label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<?php 
									...
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-12" for=""><?php echo $this->lang->line('matters_25'); ?></label>
										<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="input-group">
												<script>
													$( function() {
									...
									<div class="form-group">
										...
										<div class="mat_description_wrap">
											...
											<?php echo $this->lang->line('matters_detail_43'); ?>
											<br>
											<br> 
									...
									<div class="form-group">
										...
										<div class="col-md-6 col-sm-6 col-xs-12">
											<button type="button" onclick="createContact('ContactID_R','Contact_R')" class="btn btn-primary btn-lg btn-block">
												<i class="fa fa-plus" aria-hidden="true" style="font-family:Arial, FontAwesome"></i> 
												<?php echo $this->lang->line('matters_23'); ?></button>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
												...
												<a id="cancel" href="<?=base_app()?>Matters" class="btn btn-primary"><?php echo $this->lang->line('matters_33'); ?></a>
												<button id="next" type="button"  onclick="openCity(event, 'IntakeDetails')" class="btn btn-primary"><?php echo $this->lang->line('matters_34'); ?></button>
											</div>
										</div>
									...
									<div id="IntakeDetails" class="tabcontent">
										...
										<div class="form-group row">
											<label for="" class="control-label col-md-3 col-sm-3 col-xs-12"><?php echo $this->lang->line('matters_24'); ?></label>
											<div class="col-md-5">
												<div class="input-group">
					...
					<!-- contenido 3 -->    
					<div role="tabpanel" class="tab-pane fade active in" id="tcontenido3" aria-labelledby="profile-tab">
						<div id="task1" class="col-md-12">
							...
							<div id="listNoteWrap">
								...
								<button class="accordion">	
									<?php echo $this->lang->line('matters_detail_9'); ?>(<?=count($ContactAsociated)?>)
								</button>
								...
								<div class="panelaccc">
									...
									<table class="table2">
										<tr>
											<th><?php echo $this->lang->line('matters_detail_10'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_11'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_12'); ?></th>
										</tr>
								...
								<button class="accordion"><?php echo $this->lang->line('matters_detail_13'); ?>(<?=count($relatedMatter)?>)</button>
								<div class="panelaccc">
									<table class="table2">
										<tr>
											<th><?php echo $this->lang->line('matters_detail_14'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_15'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_12'); ?></th>
										</tr>	
								...
								<button class="accordion"><?php echo $this->lang->line('matters_detail_16'); ?>(<?=count($relatedDoc)?>)</button>

								<div class="panelaccc">
									<table class="table2">
										<tr>
											<th><?php echo $this->lang->line('matters_detail_17'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_18'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_19'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_12'); ?></th>
										</tr>	
								...
								<button class="accordion"><?php echo $this->lang->line('matters_detail_20'); ?>(<?=count($events) ?>)</button>
								<div class="panelaccc">

									<table class="table2">
										<tr>
											<th><?php echo $this->lang->line('matters_detail_21'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_22'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_23'); ?></th>
											<th><?php echo $this->lang->line('matters_detail_12'); ?></th>
										</tr>	
										<?php
								...
								<span class="plusRelCl"   onclick="createTask('<?=$Matter->Id?>','Matters/Details/<?=$Matter->Id?>?tab=records')" >
									...
									<button class="accordion"><?php echo $this->lang->line('matters_detail_24'); ?>(<?=count($relatedTask)?>)</button>
									<div class="panelaccc">

										<table class="table2">
											<tr>
												<th><?php echo $this->lang->line('matters_detail_21'); ?></th>
												<th><?php echo $this->lang->line('matters_detail_25'); ?></th>
												<th><?php echo $this->lang->line('matters_detail_23'); ?></th>
												<th><?php echo $this->lang->line('matters_detail_12'); ?></th>
											</tr>	
			...
			<div class="col-md-3 sum">
				...
				<div class="desp"  onclick="slideDown('sumTask')">
					...
					&nbsp; &nbsp; <?php echo $this->lang->line('matters_detail_24'); ?> <span><img src="<?=base_app()?>img/sumaryRowl.png"></span>
				</div>
				...
				<div class="matCat" id="sumTask">
					...
					if(count($relatedTask)>0){  
						...
						echo '<br> &nbsp; &nbsp; '.$this->lang->line('matters_detail_27').'';	
			...
			<div class="col-md-3 sum">
				...
				<div class="desp"  onclick="slideDown('sumBalance')">
					...
					&nbsp; &nbsp; <?php echo $this->lang->line('matters_detail_28'); ?> <span><img src="<?=base_app()?>img/sumaryRowl.png"></span>
				</div>
			...
			<div class="col-md-3 sum">
				...
				<div class="desp"  onclick="slideDown('sumInvo')">
					...
					&nbsp; &nbsp;<?php echo $this->lang->line('matters_detail_29'); ?> <span><img src="<?=base_app()?>img/sumaryRowl.png"></span>
				</div>
				...
				<div class="matCat" id="sumInvo">
					...
					foreach ($InvoicesRel as $invo) {
						...
						<a style="" href="<?=base_app()?>Billing/invoice_details/<?=$invo->Id.'?url='.$Matter->Id?>">
							...
							echo traducirFactura($this->lang->line('main_9'),$invo->Status).' | ';
			...
			<div class="col-md-9 recentbox ">
				<div class="x_panel">
					...
					<div id="recent-activity" class="x_title">
						<h2> &nbsp; <img src="<?=base_app()?>img/recentActivity.png"> &nbsp; <?php echo $this->lang->line('matters_detail_26'); ?></h2>
	...
	<script type="text/javascript">
		...
		// $('#modal-event1').css('border','10px solid blue');
		// $('#modal-event1').css('display','none');
