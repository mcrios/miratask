...
<style>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12" id="titulo" >
 	<h3><?php echo $this->lang->line('matters_1'); ?></h3><hr>
 </div>
 		...
 		<div class="col-xs-3 panel_cat">
 			<div class="x_panel">
 				...
 				<div id="matters" class="x_title">
 					<h2><i class="fa fa-balance-scale"></i> &ensp;<?php echo $this->lang->line('matters_2'); ?></h2>
 				...
 				<div id="content-matters" class="matCat">
					...
					<a id="addArea" onclick="atachTo('Ajax/addArea')" class="btn" > <i class="fa fa-plus-circle"></i>&ensp;<?php echo $this->lang->line('matters_58'); ?></a>


 					<a href="<?=base_app()."Matters/ChangeArea/ALL"?>"> 
 						<?php echo $this->lang->line('matters_2'); ?>
 					</a>	
 				...
 				<div class="col-xs-12  buttWrap">
 					...
 					<div class="col-md-3 pl0">
 						<a id="add_matters" href="<?=base_app()?>Matters/CreateNew" class="btn btn-primary btn-lg btn-block" >
 							<i class="fa fa-plus"></i> &nbsp; <?php echo $this->lang->line('matters_3'); ?>
 						</a>
 					</div>
 					<!-- boton " Desactivar Matters" --> 
 					<div class="btn-group ml-2 listButtWrap">

 						<button id="abc" type="button" class="btn btn-lg btn-secondary"><?php echo $this->lang->line('matters_5'); ?></button>
 						...
 						<ul class="dropdown-menu btn-block" role="menu" style="">
 							<li><a class="dropdown-item" onclick="AtachList('Matters/DesactivarList/1')"><?php echo $this->lang->line('matters_12'); ?></a></li>
 							<li><a class="dropdown-item" onclick="AtachList('Matters/DesactivarList/2')"><?php echo $this->lang->line('matters_5'); ?></a></li>
 						</ul>
 					</div>

 					<!-- boton " Delete Matters" -->
 					<div class="col-md-3">
 						<input type="submit" id="delete_matters"   class="btn fa-trash btn-block" value="&#xf1f8; <?php echo $this->lang->line('matters_4'); ?>" style="font-family:Arvo, FontAwesome" />
 					</div>
 					...
 					<div class="col-md-3">
 						...
 						<div class="btn-group ml-2 listButtWrap">
 							...
 							<ul class="dropdown-menu btn-block listABC" role="menu">
 								...
 								<li><a class="dropdown-item" href="<?=base_app()?>Matters/ListAlpha/ALL"><?php echo $this->lang->line('modal_time_3'); ?></a>
 								</ul>
 							</div>
 					...
 					<div class="col-xs-12">
 						<div class="container container-tabs" style="padding: 0px 0px">
 							<div class="col-lg-3" style="padding: 0px 0px">
 								<a href="<?=base_app().'Matters/ChangeArea/ALL'?>" class="btn btn-primary btn-lg btn-block tabs ALL"><?php echo $this->lang->line('matters_2'); ?></a>
 							</div>
 							<div class="col-lg-3" style="padding: 0px 0px">
 								<a href="<?=base_app().'Matters/ChangeArea/Actived'?>" class="btn btn-primary btn-lg btn-block tabs Actived" ><?php echo $this->lang->line('matters_12'); ?></a>
 							</div>
 							<div class="col-lg-3" style="padding: 0px 0px">
 								<a href="<?=base_app().'Matters/ChangeArea/Desactivated'?>" class="btn btn-primary btn-lg btn-block tabs Desactivated"><?php echo $this->lang->line('matters_5'); ?></a>
 							</div>
 							<div class="col-lg-3" style="padding: 0px 0px">
 								<a href="<?=base_app().'Matters/ChangeArea/Overdue'?>" class="btn btn-primary btn-lg btn-block tabs Overdue"><?php echo $this->lang->line('days_5'); ?></a>
 							</div>
 						</div>
 						...
 						<div id="resultTable">
 							<table  class="table table-bordered table-inverse">
 								<thead>
 									<tr>
 										<th> </th>
 										<th><?php echo $this->lang->line('matters_6'); ?></th>
 										<th>ID</th>
 										<th><?php echo $this->lang->line('matters_7'); ?></th>
 										<th><?php echo $this->lang->line('matters_8'); ?></th>
 										<th><?php echo $this->lang->line('matters_9'); ?></th>
 										<th><?php echo $this->lang->line('matters_10'); ?></th>
 										<th><?php echo $this->lang->line('matters_11'); ?></th>
 									</tr>
 								</thead>
 								...
 								<tbody>
 									...
 									foreach ($Matters as $row){ 
 										...
 										<tr class="<?=$alert?>">
 											...
 											<td><?=$row->MatterID?></td>
 											<td><?=($contact->FirstName!=""?$contact->FirstName." ".$contact->Middle." ".$contact->LastName." ".$contact->Contact:$contact->Company)?></td>
 											<td><?=$Area->Name?></td>
 											<td><?php
 											$i=1;
