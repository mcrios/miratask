...
<div class="formNote" >
	...
	<br>
		<div class="notesSend">
			<input type="submit" value="<?php echo $this->lang->line('contacts_40'); ?>" id="save_close"  class="btn btn-primary " >
			<?php echo "<br>".$this->lang->line('none_2')." ".$notesCreated->total." ".$this->lang->line('none_3'); ?>
		</div>
	</form> 
