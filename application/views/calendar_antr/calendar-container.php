	...
	<div class="row">
		<div class="col-xs-10">
			...
			<div class="">
				...
				<a href="javascript:add_event()" class="btn btn-primary btn-gray"> <span class="glyphicon glyphicon-plus"></span> Add Event</a>
			...
			<div class="x_panel">
				...
				<div id="matters" class="x_title">
					<h2><i class="glyphicon glyphicon-calendar"></i> &ensp;Calendar</h2>
					<div class="clearfix"></div>
				</div>
				
				<div class="calendar-buttons">
					<div class="row">
						<div class="col-xs-5 text-center views-calendar">
							<a href="javascript:calendar_change_view('day')" class="btn btn-gray btn-day">Day</a>
							<a href="javascript:calendar_change_view('week')" class="btn btn-gray btn-week">Week</a>
							<a href="javascript:calendar_change_view('month')" class="btn btn-gray btn-month active">Month</a>
						</div>
						<div class="col-xs-4 text-center">
							<label class="calendar-current-day">August 09-31-2017</label>
						</div>
						<div class="col-xs-3">
							<a href="" class="btn btn-gray">Today</a>
		...
		<div class="col-xs-2">
			...
			<div class="x_panel">
				<div id="matters" class="x_title">
					<h2 style="width: 100%">Show Calenders</h2>
...
<script type="text/javascript">
	...
	var calendar_widget=new WI_Calendar(date0,{
		...
		removeHeader:true,
		days_format:new Array("Su","Mo","Tu","We","Th","Fr","Sa"),
	...
	config={
		...
		days_format:new Array('Sunday','Monday','Tuesday','Wednesday','Thursday','Friday','Saturday'),
		removeHeader:true,
		viewType:'month',
...
<script type="text/javascript">
	...
	$(document).on("mouseenter",".wi-data-calendar-item, .wi-data-calendar-item-day",function(){
		...
		panel.find(".preview-event-header").text($(this).data("subject").substr(1,30));
