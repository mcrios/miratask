...
class UserModel extends CI_Model {
	...
	public function Attorney()
	{
		...
		$stringQuery="SELECT Id,  Name, LastName FROM ml_us_users WHERE Role in ('1', '2', '3') and state = 1  ORDER BY Name ASC ";
	...
	{
		$stringQuery="SELECT * FROM ml_us_users WHERE State='1' ORDER BY Name ASC ";
