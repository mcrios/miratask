...
class Calendar_model extends CI_Model {
	...
	function owners_get(){
		$sql="SELECT * FROM ml_us_users WHERE state=1 ORDER BY Name";
	...
	function events_get($users,$year,$month){
		...
		$sql.=" ORDER BY a.start_date ASC, start_time ASC"; //, (DATEDIFF(end_fulldate,start_fulldate)+1) DESC
		//echo $sql;
		$r=$this->db->query($sql)->result();
		return $r;
	}
	...
	function events_by_matter($id_matter){
		$sql="SELECT b.id, b.subject, b.start_date, b.location, b.start_time
